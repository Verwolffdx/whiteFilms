<?php
    session_start();
    require_once 'D:\OpenserverFolder\OSPanel\domains\whiteFilms\config\connectionDB.php';
    ...
    if ( $_FILES['user_file']['error'] == UPLOAD_ERR_OK ) {
        do {
            ...
            $path = 'D:/OpenserverFolder/OSPanel/domains/whiteFilms/assets/uploads/'.$rndName.$namePoster;
